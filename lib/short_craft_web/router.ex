defmodule ShortCraftWeb.Router do
  use ShortCraftWeb, :router

  import ShortCraftWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {ShortCraftWeb.Layouts, :root}
  ...
  # scope "/api", ShortCraftWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:short_craft, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: ShortCraftWeb.Telemetry
  ...
  scope "/", ShortCraftWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{ShortCraftWeb.UserAuth, :redirect_if_user_is_authenticated}] do
